    ...
    <div class="all-div">
      ...
      <div class="content-div">
        <div class="leftcontent-div">
          ...
          <div class="house-div">
            <houseDetail v-for="house in houseData" :key="house.ID" :house="house"/>
            <div class="page-div">
              共有 1296 个有关北京新房楼盘
...
<script>
  ...
  import cmpFixTwo from '@/components/cmpFixTwo'
  import RightAd from "./components/rightAd";
  import GuessdetailDiv from "./components/guessdetail-div";
  import Infoitem2Div from "./components/infoitem2-div";
    export default {
        name: "Index",
        components:{Infoitem2Div, GuessdetailDiv, RightAd, houseDetail,cmpFixTwo},
         data(){
          let dataBus={houseData:[]};
           this.$axios.get('http://localhost:8080/api/house/page/1').then(res=>{
              let json=res.data;
              if(json.err){
                alert('请求失败了')
              }else {
